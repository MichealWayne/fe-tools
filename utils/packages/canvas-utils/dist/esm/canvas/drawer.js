 ...
 * @since 1.0.0
 */
export function drawLine(ctx, _a, _b) {
    var x1 = _a.x, y1 = _a.y;
    var x2 = _b.x, y2 = _b.y;
    ctx.beginPath();
    ctx.moveTo(x1, y1);
 ...
 */
export function drawDashLine(ctx, _a, _b, dashLen) {
    var x1 = _a.x, y1 = _a.y;
    var x2 = _b.x, y2 = _b.y;
 ...
 * @since 1.0.0
 */
export function drawPoint(ctx, centerPoint, color, strokeColor, width, strokeWidth) {
 ...
 * @since 1.0.0
 */
export function drawRotateText(ctx, rotatePoint, degree, text) {
    ctx.save();
 ...
 * @since 1.0.0
 */
export function clearArc(ctx, point, width) {
    var ox = point.x;
    var oy = point.y;
    var step = 0.1;
