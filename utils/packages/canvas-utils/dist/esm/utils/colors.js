 ...
 */
export function getColorRgbList(color) {
    var _a;
 ...
 */
export function getColorRgba(str, opacity) {
 ...
 */
export function isTransparentColor(colorStr) {
    if (!colorStr)
        return false;
 ...
 */
export function getLightfulRgbList(color, weight) {
