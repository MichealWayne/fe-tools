...
exports.retinaScale = exports.clearArc = exports.drawRotateText = exports.drawPoint = exports.drawDashLine = exports.drawLine = void 0;
/**
 * @function drawLine
 ...
 */
function drawDashLine(ctx, _a, _b, dashLen) {
    var x1 = _a.x, y1 = _a.y;
    var x2 = _b.x, y2 = _b.y;
    if (dashLen === void 0) { dashLen = 5; }
    var beveling = _getBeveling(x2 - x1, y2 - y1); // 斜边的总长度
    var num = ~~(beveling / dashLen); // 计算有多少个线段
    ctx.beginPath();
    for (var i = 0; i < num; i++) {
...
exports.drawDashLine = drawDashLine;
/**
 * @function drawPoint
 ...
 * @since 1.0.0
 */
function drawPoint(ctx, centerPoint, color, strokeColor, width, strokeWidth) {
    if (strokeColor === void 0) { strokeColor = '#fff'; }
 ...
 * @since 1.0.0
 */
function drawRotateText(ctx, rotatePoint, degree, text) {
    ctx.save();
...
exports.drawRotateText = drawRotateText;
/**
 * @function clearArc
 ...
 * @since 1.0.0
 */
function clearArc(ctx, point, width) {
    var ox = point.x;
    var oy = point.y;
    var step = 0.1;
    function _clearArc(x, y, radius) {
        var calcWidth = radius - step;
 ...
 * @since 1.0.0
 */
function retinaScale(canvas, ctx) {
    ...
    var storedSize = canvas.__feToolsRetinaSize;
    if (storedSize && storedSize.pixelRatio === pixelRatio) {
        return pixelRatio;
    }
    var width = (storedSize === null || storedSize === void 0 ? void 0 : storedSize.width) ||
        (canvas.style.width ? parseFloat(canvas.style.width) : canvas.width);
    var height = (storedSize === null || storedSize === void 0 ? void 0 : storedSize.height) ||
    ...
    canvas.__feToolsRetinaSize = { width: width, height: height, pixelRatio: pixelRatio };
    return pixelRatio;
}
