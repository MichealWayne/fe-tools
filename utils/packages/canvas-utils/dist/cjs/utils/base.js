...
exports.throwError = exports.cloneArray = exports.cloneObjDeep = exports.each = exports.NOOP = void 0;
 ...
 * @since 1.0.0
 */
function cloneObjDeep(fromObj, toObj) {
    if (!(0, utils_1.isObject)(fromObj) || !(0, utils_1.isObject)(toObj)) {
        return {};
    }
    for (var i in fromObj) {
        if ((0, utils_1.isObject)(toObj[i]) && !(0, utils_1.isEmptyObj)(toObj[i])) {
            // obj
...
exports.cloneObjDeep = cloneObjDeep;
/**
 * @function cloneArray
 ...
 * @since 1.0.0
 */
var cloneArray = function (fromArr, toArr) {
    each(fromArr, function (item, index) {
        toArr[index] = item;
    });
    return toArr;
};
 ...
 * @since 1.0.0
 */
function throwError(info, part, detail) {
    if (part === void 0) { part = ''; }
    if (detail === void 0) { detail = ''; }
    throw new Error("Error!".concat(info, ".(").concat(part, " ").concat(detail, ")"));
}
