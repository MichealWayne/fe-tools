...
function animate(opts) {
    var DELAY_TIME = 23;
    var duration = opts.duration || constants_1.DEFAULT_ANIMATION_TIME;
    var onProcess = opts.onProcess || base_1.NOOP;
    var onAnimationFinish = opts.onAnimationFinish || base_1.NOOP;
