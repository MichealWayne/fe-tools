...
exports.createCanvasElem = void 0;
var web_utils_1 = require("web-utils");
 ...
 */
function createCanvasElem(elem, _a) {
    var id = _a.id, width = _a.width, height = _a.height;
    var canvas = document.createElement('canvas');
    canvas.id = "".concat(id, "Canvas");
    canvas.width = width || (0, web_utils_1.getElementSize)(elem, 'width') || constants_1.DEFAULT_CANVAS_SIZE.width;
    canvas.height = height || (0, web_utils_1.getElementSize)(elem, 'height') || constants_1.DEFAULT_CANVAS_SIZE.height;
    elem.appendChild(canvas);
    return canvas;
}
exports.createCanvasElem = createCanvasElem;
