 ...
 */
export declare function setAnimationHooks(chartFactory: Function): void;
/**
 ...
 */
export declare function setEnvContext(chart: any, _: string, descriptor: PropertyDescriptor): PropertyDescriptor;
