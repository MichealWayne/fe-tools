 ...
 * @since 1.0.0
 */
export declare function each<T>(arr: T[], fn: (...args: any[]) => void): T[];
/**
 ...
 * @since 1.0.0
 */
export declare function cloneObjDeep(fromObj: SimpleObj, toObj: SimpleObj): Record<any, any>;
/**
 * @function cloneArray
 ...
 * @since 1.0.0
 */
export declare const cloneArray: <T>(fromArr: T[], toArr: T[]) => T[];
/**
 * @function throwError
 ...
 * @since 1.0.0
 */
export declare function throwError(info: unknown, part?: string, detail?: string): never;
