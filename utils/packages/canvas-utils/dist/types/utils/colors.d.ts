 ...
 */
export declare function getColorRgbList(color: string): number[];
/**
 ...
 */
export declare function getColorRgba(str: string, opacity?: number): string;
/**
 ...
 */
export declare function getLightfulRgbList(color: string, weight?: number): number[];
