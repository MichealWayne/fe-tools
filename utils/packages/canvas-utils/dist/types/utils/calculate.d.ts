 ...
 */
export declare const min: typeof arrayMin;
/**
 * @function max
 ...
 * @see {@link getListExtremum} - For finding both min and max in one operation
 */
export declare const max: typeof arrayMax;
/**
 ...
 */
export declare function getListExtremum(arr: number[]): ListExtremum;
/**
 ...
 * @since 1.0.0
 */
export declare function getAxisLimit(range?: number): number;
/**
 ...
 */
export declare function getPointsAngle({ x: x1, y: y1 }: PointPosition, { x: x2, y: y2 }: PointPosition): number;
/**
 ...
 */
export declare function getPointsDistance({ x: x1, y: y1 }: PointPosition, { x: x2, y: y2 }: PointPosition): number;
