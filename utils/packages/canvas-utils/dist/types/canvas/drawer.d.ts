 ...
 * @since 1.0.0
 */
export declare function drawLine(ctx: CanvasRenderingContext2D, { x: x1, y: y1 }: PointPosition, { x: x2, y: y2 }: PointPosition): void;
/**
 ...
 */
export declare function drawDashLine(ctx: CanvasRenderingContext2D, { x: x1, y: y1 }: PointPosition, { x: x2, y: y2 }: PointPosition, dashLen?: number): void;
/**
 * @function drawPoint
 ...
 * @since 1.0.0
 */
export declare function drawPoint(ctx: CanvasRenderingContext2D, centerPoint: PointPosition, color: string, strokeColor?: string, width?: number, strokeWidth?: number): void;
/**
 ...
 * @since 1.0.0
 */
export declare function drawRotateText(ctx: CanvasRenderingContext2D, rotatePoint: PointPosition, degree: number, text: string | number): void;
/**
 * @function clearArc
 ...
 * @since 1.0.0
 */
export declare function clearArc(ctx: CanvasRenderingContext2D, point: PointPosition, width: number): void;
/**
 ...
 * @since 1.0.0
 */
export declare function retinaScale(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D): number;
