 ...
 * capitalize('a'); // -> 'A'
 */
export declare function capitalize(paramString: string): string;
/**
 ...
 * decapitalize('A'); // -> 'a'
 */
export declare function decapitalize([first, ...rest]: string): string;
/**
 * @function splitLines
 ...
 */
export declare function fromCamelCase(str: string, separator?: string): string;
/**
 ...
 */
export declare function ellipsis(str: string, maxLength?: number, ellipsisStr?: string): string;
/**
 * @function maskString
 ...
 */
export declare function maskString(str: string, startVisible?: number, endVisible?: number, maskChar?: string): string;
/**
 * @function isChinese
