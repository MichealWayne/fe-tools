 ...
 */
export declare function groupBy<T>(arr: T[], fn: (item: T) => string | number): Record<string, T[]>;
/**
 * @function partition
 ...
 */
export declare function partition<T>(arr: T[], fn: (item: T) => boolean): [T[], T[]];
/**
 * @function zip
 ...
 */
export declare function unzip(arr: any[][]): any[][];
/**
 * @function sortBy
 ...
 */
export declare function sortBy<T>(arr: T[], ...fns: Array<(item: T) => any>): T[];
/**
 ...
 */
export declare function mergeSorted<T>(...arrays: T[][]): T[];
