 ...
 * }
 */
export declare function attempt<T extends unknown[], R>(fn: (...fnArgs: T) => R, ...args: T): Error | R;
/**
 * @function defer
 ...
 * }
 */
export declare function defer(fn: (...arg: unknown[]) => unknown, ...args: unknown[]): Promise<void>;
/**
 ...
 */
export declare function runPromisesInSeries(ps: Array<(...args: unknown[]) => Promise<any>>): Promise<void>;
/**
 * @function timeTaken
 ...
 * ];
 */
export declare function timeTaken(fn: (...ks: unknown[]) => unknown, ...args: unknown[]): unknown;
/**
 * @function memoize
 ...
 */
export declare function memoize(fn: (...args: unknown[]) => unknown): {
    (val: unknown): any;
    cache: Map<any, any>;
};
/**
 ...
 * });
 */
export declare function once(fn: (...args: unknown[]) => unknown): (...argus: unknown[]) => void;
/**
 * @function chainAsync
 ...
 */
export declare function chainAsync(fns: Array<(...args: unknown[]) => unknown>): void;
/**
 * @function compose
 ...
 */
export declare function pipe<T extends unknown[]>(...fns: Array<(...arg: any[]) => any>): (...arg: any[]) => any;
 ...
 */
export declare function functionName<T extends (...ks: unknown[]) => unknown>(fn: T): string;
/**
 * @function promisify
 ...
 */
export declare function promisify<T extends unknown[], R>(fn: (...args: [args: T, errHandler?: (err: Error | null, result?: R) => void]) => void): (...args: T) => Promise<R>;
/**
 * @function sleep
 ...
 * }, 300);
 */
export declare function throttle<F extends (...args: any[]) => any>(fn: F, intervalTime?: number): (...args: Parameters<F>) => void;
 ...
 * });
 */
export declare function debounce<T extends unknown[]>(fn: (...args: T) => void, intervalTime?: number): DebouncedFn<T>;
export {};
