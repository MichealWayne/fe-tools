 ...
 */
export declare const isInt: (val: unknown) => val is number;
/**
 * @function isOdd
 ...
 */
export declare const isFloat: (val: unknown) => val is number;
/**
 ...
 */
export declare function isValidNumber(val: unknown): boolean;
/**
 ...
 */
export declare function isApproximatelyEqual(val1: number, val2: number, epsilon?: number): boolean;
/**
 * @function average
 ...
 */
export declare function randomNumberInRange(min: number, max: number): number;
/**
 ...
 */
export declare function randomIntArrayInRange(min: number, max: number, num?: number): number[];
/**
 * @function round
