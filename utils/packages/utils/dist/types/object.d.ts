 ...
 */
export declare function forOwn(obj: PlainObject, fn: (val?: unknown, key?: string, obj?: PlainObject) => void): void;
/**
 ...
 */
export declare function objectFromPairs(arr: [string, unknown][]): PlainObject;
/**
 * @function mapObject
 ...
 */
export declare function mapObject<T, U>(arr: T[], fn: (value: T, index: number, array: T[]) => U): Record<T extends string ? T : string, U>;
/**
 * @function pick
 ...
 */
export declare function pick(obj: PlainObject, keys: string[]): PlainObject;
/**
 ...
 */
export declare function hasOwnProperty<T extends Record<string, unknown>>(obj: T, key: PropertyKey): key is keyof T;
/**
 * @function isEmptyObj
