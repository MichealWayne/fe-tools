 ...
 */
export declare function getColonTimeFromDate(date?: Date): string;
/**
 ...
 */
export declare function getDaysDiffBetweenDates(dateInitial: Date, dateFinal: Date): number;
/**
 ...
 */
export declare function isAfterDate(dateA: Date, dateB?: Date): boolean;
/**
 ...
 */
export declare function isBeforeDate(dateA: Date, dateB?: Date): boolean;
/**
 * @function daysLater
 ...
 */
export declare function daysLater(date?: Date, days?: number): string;
/**
 ...
 */
export declare function getFormattedRemainTime(dateInitial: Date, dateFinal: Date): {
    day: number;
    hour: number;
    minute: number;
    second: number;
