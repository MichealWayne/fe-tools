...
exports.digitUppercase = exports.compareVersion = void 0;
 ...
 */
function compareVersion(v1Str, v2Str) {
    var v1 = v1Str.split('.');
    var v2 = v2Str.split('.');
...
function digitUppercase(num) {
    ...
    var resStr = '';
    // 处理小数部分
    var cents = Math.round((num - Math.floor(num)) * 100); // 取小数点后两位
    if (cents > 0) {
