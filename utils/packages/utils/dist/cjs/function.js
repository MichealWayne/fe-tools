...
exports.debounce = exports.throttle = exports.sleep = exports.promisify = exports.functionName = exports.curry = exports.pipe = exports.compose = exports.chainAsync = exports.once = exports.memoize = exports.timeTaken = exports.runPromisesInSeries = exports.defer = exports.attempt = exports.NOOP = void 0;
/**
 * @function NOOP
...
function compose() {
    ...
    return fns.reduce(function (f, g) {
        return function () {
            ...
            return f(g.apply(void 0, __spreadArray([], __read(arg), false)));
        };
    });
}
...
function pipe() {
    ...
    return fns.reduce(function (f, g) {
        return function () {
            ...
            return g(f.apply(void 0, __spreadArray([], __read(arg), false)));
        };
    });
}
exports.pipe = pipe;
...
var curry = function (callback) {
    return function () {
        ...
        if (args.length < callback.length) {
            return (0, exports.curry)(callback.bind.apply(callback, __spreadArray([null], __read(args), false)));
        }
...
function throttle(fn, intervalTime) {
    if (intervalTime === void 0) { intervalTime = DEFAULT_INTERVAL; }
    var flag = true;
    return function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
