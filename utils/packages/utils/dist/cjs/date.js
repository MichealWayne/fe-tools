...
exports.getFormattedRemainTime = exports.daysLater = exports.isBeforeDate = exports.isAfterDate = exports.getDaysDiffBetweenDates = exports.getColonTimeFromDate = exports.dayOfYear = void 0;
/**
 * @function dayOfYear
...
function isAfterDate(dateA, dateB) {
    if (dateB === void 0) { dateB = new Date(); }
    return dateA > dateB;
}
 ...
 */
function getFormattedRemainTime(dateInitial, dateFinal) {
    var time = +dateFinal - +dateInitial;
    var day = 0;
    var hour = 0;
    var minute = 0;
    var second = 0;
...
exports.getFormattedRemainTime = getFormattedRemainTime;
