...
exports.isBase64 = exports.isMACAddress = exports.isValidPhoneNumber = exports.isSemVer = exports.isJWT = exports.isPort = exports.isIPv4 = exports.isHexColor = exports.isCreditCard = exports.isValidURL = exports.isValidEmail = exports.isValidJSON = void 0;
/**
...
function isJWT(str) {
    ...
    if (parts.length !== 3)
        return false;
    return parts.every(function (part) { return /^[A-Za-z0-9_-]+$/.test(part); });
}
exports.isJWT = isJWT;
/**
 * @function isSemVer
