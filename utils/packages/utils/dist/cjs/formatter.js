...
exports.formatOrdinal = exports.formatPercentage = exports.formatPhone = exports.formatRelativeTime = exports.formatCurrency = exports.formatNumber = exports.formatDuration = exports.formatFileSize = void 0;
/**
...
function formatNumber(num, decimals, separator) {
    ...
    var parts = typeof decimals === 'number' ? num.toFixed(decimals).split('.') : num.toString().split('.');
...
function formatCurrency(amount, currency, decimals) {
    ...
    if (decimals === void 0) { decimals = 2; }
    return "".concat(currency).concat(formatNumber(amount, decimals));
}
 ...
 */
function formatPercentage(value, decimals, isDecimal) {
    if (decimals === void 0) { decimals = 2; }
    if (isDecimal === void 0) { isDecimal = true; }
    var percentage = isDecimal ? value * 100 : value;
