 ...
 */
export function insertAfter(elem, htmlString) {
 ...
 */
export function insertBefore(elem, htmlString) {
 ...
 */
export function setAttribute(elem, key, value) {
 ...
 */
export function getOffsetPos(elem) {
    var pos = {
        left: 0,
        top: 0,
    };
 ...
 */
export function setScrollTop(height) {
