...
exports.resourceTiming = exports.createPerformanceObserver = exports.measureLoadTime = exports.measureMemory = exports.getWebVitals = exports.measureFPS = void 0;
/**
 * @function measureFPS
 ...
 */
function measureFPS(callback, duration) {
...
function getWebVitals(callback) {
    ...
    setTimeout(function () { return callback(metrics); }, 3000);
}
 ...
 * });
 */
function createPerformanceObserver(entryTypes, callback) {
    if (!('PerformanceObserver' in window)) {
        return null;
    }
    try {
 ...
 */
function resourceTiming(resourceUrl) {
    var resources = performance.getEntriesByType('resource');
    var filtered = resourceUrl ? resources.filter(function (r) { return r.name.includes(resourceUrl); }) : resources;
    return filtered.map(function (entry) { return ({
        name: entry.name,
