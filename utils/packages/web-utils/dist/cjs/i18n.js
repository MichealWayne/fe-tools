...
exports.formatRelativeTime = exports.getDirection = exports.pluralize = exports.formatCurrencyLocale = exports.formatNumberLocale = exports.formatDateLocale = exports.getLocale = void 0;
/**
 * @function getLocale
 ...
 */
function formatDateLocale(date, locale, options) {
 ...
 */
function formatNumberLocale(num, locale, options) {
    var localeStr = locale || getLocale();
 ...
 */
function formatCurrencyLocale(amount, currency, locale) {
    var localeStr = locale || getLocale();
...
function formatRelativeTime(value, unit, locale) {
    var localeStr = locale || getLocale();
    var rtf = new Intl.RelativeTimeFormat(localeStr, { numeric: 'auto' });
