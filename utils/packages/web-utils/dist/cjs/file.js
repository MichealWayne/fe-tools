...
exports.getFileExtension = exports.downloadImageFileByUrl = exports.downloadFile = exports.readFileAsDataURL = exports.readFile = void 0;
/**
 * @author Wayne
 ...
 */
function downloadImageFileByUrl(url, filename, imageType) {
    if (imageType === void 0) { imageType = 'image/jpeg'; }
    return new Promise(function (resolve, reject) {
...
exports.downloadImageFileByUrl = downloadImageFileByUrl;
/**
