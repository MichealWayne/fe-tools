...
exports.getElementSize = exports.getStyle = exports.getPrefix = void 0;
...
function getPrefix() {
    ...
    if ((0, utils_1.isUndefined)(testEl.style.transform)) {
        for (var i in vendors) {
            if (!(0, utils_1.isUndefined)(testEl.style["".concat(i, "TransitionProperty")])) {
                return vendors[i];
            }
        }
    }
...
function getStyle(elem, property) {
    var _a;
    var value = ((_a = elem.currentStyle) === null || _a === void 0 ? void 0 : _a[property]) ||
        document.defaultView.getComputedStyle(elem, null).getPropertyValue(property);
    var matches = value === null || value === void 0 ? void 0 : value.match(/^(\d+)(\.\d+)?px$/);
 ...
 */
function getElementSize(elem, property) {
    var _a;
    // IE currentStyle
    var value = elem.currentStyle
        ? elem.currentStyle[property]
        : (_a = document.defaultView) === null || _a === void 0 ? void 0 : _a.getComputedStyle(elem, null).getPropertyValue(property);
    var matches = value === null || value === void 0 ? void 0 : value.match(/^(\d+)(\.\d+)?px$/);
