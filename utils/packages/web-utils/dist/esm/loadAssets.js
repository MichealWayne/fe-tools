 ...
 * })
 */
export function loadScript(url, isCrossOrigin) {
 ...
 * })
 */
export function loadScriptList(urls, isCrossOrigin, isAsync) {
    if (isCrossOrigin === void 0) { isCrossOrigin = true; }
    if (isAsync === void 0) { isAsync = true; }
    if (isAsync)
        return Promise.all(urls.map(function (url) { return loadScript(url, isCrossOrigin); }));
    return runPromisesInSeries(urls.map(function (url) { return function () { return loadScript(url, isCrossOrigin); }; }));
}
/**
 * @function loadCss
 * @description 动态加载css
 ...
 * }
 */
export function loadCssList(cssList) {
 ...
 * }
 */
export function loadImageList(imageUrls) {
 ...
 */
export function loadCSV(csvStr, name, type) {
