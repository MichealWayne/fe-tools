 ...
 */
export declare function getStyle(elem: any, property: string): number | undefined;
/**
 ...
 */
export declare function getElementSize(elem: HTMLElement, property: string): number;
