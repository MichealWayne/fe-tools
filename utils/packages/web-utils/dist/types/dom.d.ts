 ...
 */
export declare function insertAfter(elem: HTMLElement, htmlString: string): void;
/**
 ...
 */
export declare function insertBefore(elem: HTMLElement, htmlString: string): void;
/**
 ...
 */
export declare function hide(...elems: HTMLElement[]): void;
/**
 ...
 */
export declare function nodeListToArray(nodeList: HTMLElement[]): HTMLElement[];
/**
 ...
 */
export declare function setAttribute(elem: HTMLElement, key: string, value: string): void;
/**
 ...
 */
export declare function getOffsetPos(elem?: HTMLElement): {
    left: number;
    top: number;
};
/**
 ...
 */
export declare function getScrollPosition(elem?: Window & typeof globalThis): {
    x: number;
    y: number;
};
/**
 ...
 */
export declare function setScrollTop(height: number): number;
/**
...
export declare const requestAnimFrame: (((callback: FrameRequestCallback) => number) & typeof requestAnimationFrame) | ((callback: (...args: unknown[]) => unknown) => void);
/**
 ...
 */
export declare function animateScrollTo(to: number, duration: number): void;
/**
 ...
 */
export declare function smoothScroll(elemSelector: string): void;
/**
