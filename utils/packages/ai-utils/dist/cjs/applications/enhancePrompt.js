...
exports.enhancePrompt = exports.genEnhancePrompt = void 0;
/**
...
var MAX_TOKEN_LEN = 10000; // GPT-4o 32k, prompt text should be shorter
/**
 ...
 * @returns {string}
 */
function enhancePromptTxt(userPrompt) {
    return (0, applyTemplate_1.applyTemplate)(templates_1.STANDARD_PROMPT_TEMPLATE, {
        role: 'Professional Prompt Engineer',
        task_description: "Enhance the user's prompt to make it more specific, actionable, and effective for interacting with an AI model.",
        format_instructions: 'Respond ONLY with the enhanced prompt text. Do not include any explanations, metadata, or wrapper tags.',
        input_content: userPrompt,
        additional_instructions: 'For valid prompts:\n' +
 ...
 */
exports.genEnhancePrompt = (0, generator_1.createPromptGenerator)({ maxTokenLength: MAX_TOKEN_LEN }, enhancePromptTxt);
exports.enhancePrompt = exports.genEnhancePrompt;
