...
exports.genUnitTestCasesPrompt = void 0;
/**
...
var MAX_TOKEN_LEN = 30000; // GPT-4o 32k
/**
 ...
 * @returns {string}
 */
function getCreateUnitTestCasesTxt(codeToTest) {
    return (0, applyTemplate_1.applyTemplate)(templates_1.STANDARD_PROMPT_TEMPLATE, {
        ...
        task_description: 'Generate a comprehensive set of unit test cases for the provided code snippet. The tests should cover main functionality, edge cases, and potential error conditions.',
        format_instructions: 'Provide only the Jest test code in TypeScript. Do not include any explanations or markdown code block wrappers in your final response.',
        input_content: codeToTest,
        additional_instructions: '- The test environment is Node.js.\n' +
 ...
 */
exports.genUnitTestCasesPrompt = (0, generator_1.createPromptGenerator)({ maxTokenLength: MAX_TOKEN_LEN }, getCreateUnitTestCasesTxt);
