...
exports.genCodeReviewPrompt = void 0;
/**
 ...
 */
function getCodeReviewPromptTxt(patch) {
    return (0, applyTemplate_1.applyTemplate)(templates_1.STANDARD_PROMPT_TEMPLATE, {
        role: 'Frontend Expert and Code Reviewer',
        task_description: 'Perform a concise code review on the provided patch. Identify bug risks, improvement suggestions, and provide analysis in Chinese.',
        format_instructions: 'Respond with TypeScript/JavaScript code if issues are found. Ensure the result uses the following JSON format:\n' +
            '```json\n' +
            '{\n' +
            '  "score": ..,\n' +
            '  "details": [\n' +
        ...
        input_content: patch,
        additional_instructions: 'Analyze the code patch step-by-step. Focus on correctness, efficiency, and best practices.',
    });
}
/**
 ...
 */
exports.genCodeReviewPrompt = (0, generator_1.createPromptGenerator)({ maxTokenLength: MAX_TOKEN_LEN }, getCodeReviewPromptTxt);
