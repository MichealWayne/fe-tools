...
type IdentityFunction = (...args: unknown[]) => {
    key: string;
    ext: string;
};
/**
...
export default class Cache {
     ...
     */
    computeCacheDir(base: string): string;
    /**
     ...
     */
    getFilename(key: string, ext: string): string;
    /**
     ...
     * }
     */
    has(key: string, ext: string): boolean;
    /**
     ...
     */
    write(key: string, ext: string, content: unknown): Promise<boolean | undefined>;
    /**
     ...
     */
    wrapAsync(original: OriginalFunction, identity: IdentityFunction): (this: any, ...args: unknown[]) => Promise<any>;
    /**
     ...
     */
    wrapNormal(original: OriginalFunction, identity: IdentityFunction): (this: any, ...args: unknown[]) => any;
    /**
     ...
     */
    wrap(Class: ClassDecorator, identities: any): void;
}
export {};
