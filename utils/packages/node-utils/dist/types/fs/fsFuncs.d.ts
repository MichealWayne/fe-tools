 ...
 */
export declare function travelFolderSync(dirPath: string, fileCallback: (pathName?: string) => void, folderCallback: (pathName?: string) => void): void;
/**
 * @function mkdirsSync
 ...
 */
export declare function mkdirsSync(dirPath: string): boolean;
/**
 ...
 */
export declare function setFolderSync(folderPath: string, noTip?: boolean): void;
/**
 * @function rmdirsSync
 ...
 */
export declare function rmdirsSync(targetPath: string): boolean;
/**
 * @function writeFile
 ...
 * }
 */
export declare function writeFile(filePath: string, fileData: string, replace?: boolean): Promise<boolean>;
/**
 * @function writeJson
 ...
 */
export declare function writeJson(filePath: string, obj: {
    [key: string]: unknown;
}, spaceLen?: number): Promise<boolean>;
/**
...
declare const _default: {
    travelFolderSync: typeof travelFolderSync;
    fsExistsSync: typeof fsExistsSync;
    setFolderSync: typeof setFolderSync;
    mkdirsSync: typeof mkdirsSync;
    rmdirsSync: typeof rmdirsSync;
