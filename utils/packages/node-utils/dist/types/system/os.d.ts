 ...
 */
export declare function freememPercentage(): number;
/**
 ...
 */
export declare function freeCommand(callback: AnyCallbackFunc): void;
/**
 * @function harddrive
 ...
 * @since 1.0.0
 */
export declare function harddrive(callback: AnyCallbackFunc): void;
/**
 ...
 * @since 1.0.0
 */
export declare function getProcesses(nProcess: number | AnyCallbackFunc, callback: AnyCallbackFunc): void;
/**
 * @function allLoadavg
 ...
 */
export declare function allLoadavg(): string;
/**
 * @function loadavg
 ...
 */
export declare function loadavg(time?: number): number;
/**
 ...
 */
export declare function getCPUUsage(callback: AnyCallbackFunc, free?: boolean): void;
/**
 * @function cpuFree
 ...
 */
export declare function cpuFree(callback: AnyCallbackFunc): void;
/**
 * @function cpuUsage
 ...
 */
export declare function cpuUsage(callback: AnyCallbackFunc): void;
/**
 * @function getCPUInfo
...
declare const _default: {
    ...
    sysUptime: typeof sysUptime;
    processUptime: typeof processUptime;
    freemem: typeof freemem;
    totalmem: typeof totalmem;
    freememPercentage: typeof freememPercentage;
    freeCommand: typeof freeCommand;
    harddrive: typeof harddrive;
    getProcesses: typeof getProcesses;
    allLoadavg: typeof allLoadavg;
    loadavg: typeof loadavg;
    cpuFree: typeof cpuFree;
    cpuUsage: typeof cpuUsage;
    getCPUUsage: typeof getCPUUsage;
    getCPUInfo: typeof getCPUInfo;
};
