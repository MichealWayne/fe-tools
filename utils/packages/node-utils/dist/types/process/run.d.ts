 ...
 * @since 1.0.0
 */
import { type SpawnOptions, type SpawnSyncOptions } from 'child_process';
import { URL as NodeURL } from 'url';
import { EventEmitter } from 'events';
export declare const IGNORE = "__ignore__";
 ...
 */
export declare function runAsync(cmd: string | NodeURL, args?: string[], options?: RunOptions): Promise<RunResult>;
/**
 ...
 */
export declare function forceRunAsync(cmd: string | NodeURL, args?: string[], options?: RunOptions): Promise<RunResult | void>;
/**
 * @function runPromise
 ...
 * @see {@link IGNORE} - Special error message for ignored failures
 */
export declare function runPromise<T>(promise: Promise<T>): Promise<T | void>;
/**
 * @function runSync
 ...
 */
export declare function runSync(cmd: string | NodeURL, args?: string[], options?: SpawnSyncOptions): RunResult;
/**
 * @function exit
 ...
 */
export declare function exit(): never;
/**
 ...
 */
export declare const commandEvents: EventEmitter;
declare const _default: {
    runAsync: typeof runAsync;
    runSync: typeof runSync;
    forceRunAsync: typeof forceRunAsync;
    runPromise: typeof runPromise;
    exit: typeof exit;
    commandEvents: EventEmitter;
};
