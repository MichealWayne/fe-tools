 ...
 */
export function downloadFile(fileUrl, dest, options) {
    var _this = this;
    var _a;
 ...
 *   .catch(err => console.error(err));
 */
export function postJSON(requestUrl, data) {
    return new Promise(function (resolve, reject) {
 ...
 * });
 */
export function createSimpleServer(port, handler) {
 ...
 */
export function createSimpleProxy(target, port) {
 ...
 * });
 */
export function uploadFile(filePath, requestUrl, options) {
    var _this = this;
    var _a;
    var maxRedirects = (_a = options === null || options === void 0 ? void 0 : options.maxRedirects) !== null && _a !== void 0 ? _a : DEFAULT_MAX_REDIRECTS;
