...
var fsFuncs_1 = require("../fs/fsFuncs");
/**
 * @function isAsync
...
var Cache = /** @class */ (function () {
    ...
    Cache.prototype.computeCacheDir = function (base) {
        return path_1.default.join(base, '.ncu', 'cache');
    };
    /**
    ...
    Cache.prototype.getFilename = function (key, ext) {
        return path_1.default.join(this.dir, key) + ext;
    };
    /**
    ...
    Cache.prototype.has = function (key, ext) {
        ...
        return fs_1.default.existsSync(this.getFilename(key, ext));
    };
    /**
    ...
    Cache.prototype.get = function (key, ext) {
        ...
        if (ext === '.json') {
            return (0, fsFuncs_1.readJsonFile)(this.getFilename(key, ext));
        }
        return (0, fsFuncs_1.readFileSync)(this.getFilename(key, ext));
    };
    /**
    ...
    Cache.prototype.write = function (key, ext, content) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (ext === '.json') {
                    return [2 /*return*/, (0, fsFuncs_1.writeJson)(filename, content)];
                }
                return [2 /*return*/, (0, fsFuncs_1.writeFile)(filename, String(content))];
            });
        });
    };
    /**
