 ...
 */
var tipFunHoc = function (key) {
    var useColor = TIP_MAP[key];
    return function (info, timeFlag) {
        if (info) {
            var str = (timeFlag ? "".concat((0, common_1.getTimeStr)(), ":") : '') + info;
            if (useColor) {
                console.log(colors_1.default.get(useColor), str);
            }
            else {
                console.log(str);
            }
