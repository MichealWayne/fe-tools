...
- 2026.09.06：更新主页链接；更新 Chrome 插件至 v1.6.0，增加 Codex 额度查询等能力；补充前端模板和 utils 使用说明；
- 2026.07.19：升级并完善前后端项目模板（统一健康检查接口、更新模板依赖及 ESLint 配置、补充项目文档）；更新
  utils（更新注释说明）；
- 2026.06.13：更新前后端项目模版脚本与依赖；更新 utils（新增/优化多包方法、类型与单测）；
- 2026.06.06：更新主页中英文资源链接与说明；更新 Chrome 插件文档及产物；完善正则配置文件（regex.json）；
...
- 2025.08.10：更新 ai-utils；更新主页链接；更新子目录 README；
- 2025.07.20：更新前端模版依赖；
